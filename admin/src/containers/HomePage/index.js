...
const SOCIAL_LINKS = [
  ...
  {
    name: 'Twitter',
    link: 'https://twitter.com/claudiomarcosdf',
  },
      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              <h2 id="mainHeader">Bem vindo a Won Games, {upperFirst(username)}!</h2>
              <P>Ao lado você pode inserir diferentes jogos, categorias e publishers para no ssa maravilhosa loja de jogos!</P>
